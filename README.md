...
* `queries`: The SQL queries to run. This is an array of sets of arguments like you would pass to [Database#run](#run):
  ...
  > Currently, queries are passed as a command line argument to `sqlite3` directly. Typically, there is a size limit for command line arguments. On MacOS, it appears to be around 1000000 characters!
